"""
run_all_evaluations.py - Run all evaluation configurations for the report

This script systematically evaluates the CodePromptZip compressor across
different parameter settings to demonstrate:
  1. Impact of compression ratio (tau_code)
  2. Impact of number of retrieved examples (num_shots)
  3. Compression vs No-Compression baseline
  4. No-Retrieval baseline

Usage:
    python scripts/run_all_evaluations.py
    python scripts/run_all_evaluations.py --max_eval_samples 200
    python scripts/run_all_evaluations.py --skip_existing
"""
...
def main():
    parser = argparse.ArgumentParser(description="Run all evaluation experiments")
    ...
    parser.add_argument("--max_eval_samples", type=int, default=2000,
                        help="Max samples per experiment (default: 2000, matching config.yaml)")
    ...
    print("=" * 60)
    print("CodePromptZip: Full Evaluation Suite")
