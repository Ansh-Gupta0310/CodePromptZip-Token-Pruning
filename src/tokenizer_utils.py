...
def get_extended_tokenizer(model_name: str = "Salesforce/codet5-large"):
    """
    ...
    # Try fast tokenizer first; fall back to slow tokenizer if
    # HuggingFace raises AttributeError due to malformed extra_special_tokens
